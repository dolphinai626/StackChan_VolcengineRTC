...
static Data_t _data;
static std::function<void()> _xiaozhi_initialized_callback;
...
void set_xiaozhi_initialized_callback(std::function<void()> callback)
{
    _xiaozhi_initialized_callback = std::move(callback);
}
...
void start_xiaozhi_app()
{
    ...
    app.Initialize();
    if (_xiaozhi_initialized_callback) {
        _xiaozhi_initialized_callback();
    }
